...
Используем L7 балансировщик nginx ввиду его большого кол-ва достоинств и возможностей. Чтобы не возникало смещения
соединений для балансировки используем least connections стратегию.
