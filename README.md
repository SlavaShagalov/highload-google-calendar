...
Также дата-центры расположатся в остальных топ-8 странах в следующих городах:
...
можно добавить дополнительные дата-центры в:
...
Тогда карта физического расположения дата-центров примет вид (красные точки - ЦОД):

![my_distribution.jpg](img/my_distribution.jpg)
